...
//This is the second version of the program, using dynamic arrays to allocate players
...
void display_rules();
int spindie(int, int &);
int play(int [], int[][2], int &, int, int *, int &, int *, int []);
void switchplaces(int [], int[][2], int, int, int *);
void showstate(int [], int[][2], int *, int, int *);
...
int play(int board[], int players[][2], int &turn, int roll, int *pass, int &pnum, int *spaces, int skip[])
{
  int swap, action;
  swap = 0, action = 0;
...
void switchplaces(int board[], int players[][2], int turn, int pnum, int *spaces)
{
  int swap = 0, x = -1;
...
void showstate(int board[], int players[][2], int *pass, int turn, int *spaces)
{
    if (spaces[turn] != 0)
